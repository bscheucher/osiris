...
import InputCheckboxTw from '@/components/atoms/input-checkbox-tw'
...
export default function MitarbeiterStammdatenEditForm({
  personalnummer,
  submitHandler,
  stammDaten,
  isReadOnly = false,
  ...
  useFormEffect<StammdatenEntry>(
    {
      ...
      staatsbuergerschaft: (value) => {
        // citizenship logic
        const isRequired = !euCountriesFromMasterdata.includes(value)
  ...
  const formHandler = (props: StammdatenEntry) => {
    submitHandler(props)
  }
      ...
      <form onSubmit={handleSubmit(formHandler)}>
        <div className="space-y-10">
          <div className="mb-6 flex content-center items-center justify-between">
            ...
            <ButtonTw type="submit" size="xlarge" disabled={isReadOnly}>
              {t('button.speichern')}
            </ButtonTw>
          </div>
              ...
              <div className="col-span-12 flex items-start gap-4 2xl:col-span-6">
                ...
                {showResolveButton && (
                  <ButtonTw
                    ...
                    className="bg-ibis-emerald mt-8 flex gap-2 text-white ring-emerald-500 hover:bg-emerald-500"
          ...
          <div>
            <h3 className="mb-7 text-2xl leading-7 font-semibold text-gray-900">
              {t('section.zusatzinfo')}
            </h3>
            <h4 className="mb-5 text-xl leading-5 font-semibold text-gray-900">
              {t('section.arbeitsgenehmigung')}
            </h4>
            <div className="grid grid-cols-12 gap-x-8 gap-y-6 pb-12">
              <div className="col-span-6 2xl:col-span-6">
                <InputFileOnboardingTw
                  personalnummer={personalnummer}
                  label="Arbeitsgenehmigung (Dokument)"
                  placeholder="Scan von Arbeitsgenehmigung"
                  control={control}
                  name="arbeitsgenehmigungDok"
                  disabled={isReadOnly}
                  {...getOverride('arbeitsgenehmigungDok')}
                />
              </div>
              <div className="col-span-6 2xl:col-span-6">
                <ComboSelectTw
                  ...
                  options={convertToKeyLabelOptions(
                    masterdata?.arbeitsgenehmigungList
                  )}
                  placeholder="Arbeitsgenehmigung auswählen"
                  control={control}
                  name="arbeitsgenehmigung"
                  disabled={isReadOnly}
                  {...getOverride('arbeitsgenehmigung')}
                />
              </div>
              <div className="col-span-6 2xl:col-span-6">
                <DatepickerTw
                  label="Gültig bis"
                  placeholder="Gültigkeitsdatum auswählen"
                  control={control}
                  name="gueltigBis"
                  disabled={isReadOnly}
                />
            ...
            <h4 className="mb-5 text-xl leading-5 font-semibold text-gray-900">
              {t('section.arbeitsbereitschaft')}
            </h4>
            <div className="mb-8">
              <InfoSectionTw description="Hier wird hinterlegt in welchen Bundesländern der Mitarbeiter bereit ist zu arbeiten." />
            </div>
            <div className="grid grid-cols-12 gap-x-8 gap-y-6 pb-8">
              <div className="3xl:col-span-2 col-span-6 2xl:col-span-3">
                <InputCheckboxTw
                  control={control}
                  label="Burgenland"
                  name="burgenland"
