          ...
          {hasSomeRole([
            ...
            >
              <>
                ...
                <NavigationLink
                  href="/mein-bereich/personalakt-sharepoint"
                  Icon={(props) => <FolderIcon {...props} />}
                  isVisible={
                    hasSomeRole(ROLE.MA_UNTERLAGEN_LESEN) &&
                    process.env.NEXT_PUBLIC_DISPLAY_SHAREPOINT_PERSONALAKT === 'true' &&
                    process.env.NEXT_PUBLIC_SHAREPOINT_ALLOWED_NAMES?.split(',')
                      .includes(user?.fullName || '')
                  }
                  testId="meinBereich-personalakt-sharepoint"
                >
                  Personalakt Sharepoint
                </NavigationLink>
                <NavigationLink
