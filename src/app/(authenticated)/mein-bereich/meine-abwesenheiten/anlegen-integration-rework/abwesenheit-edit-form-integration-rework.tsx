...
import {AbwesenheitEntry, AbwesenheitType,} from '@/lib/utils/abwesenheit-utils'
...
export interface AbwesenheitV2Dto {
  startDate: string
  endDate: string
  type: AbwesenheitType
  comment?: string
  ...
  const onSubmit: SubmitHandler<FormValues> = async (data) => {
    ...
    try {
      await executePOST(
        `/v2/abwesenheiten`,
        data
      ) as unknown as AbwesenheitV2Dto
        ...
        <div className="mb-8 grid grid-cols-2 gap-x-8 gap-y-8 sm:grid-cols-4">
          ...
          <div className="sm:col-span-4">
            <InputSelectTw
              ...
              options={[
                {
                  key: AbwesenheitType.URLAU,
                  label: 'Urlaub (Zeitausgleich not yet supported)',
                },
              ]}
